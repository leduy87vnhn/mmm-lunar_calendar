...
Module.register("lunar_calendar", {
	...
	getDom: function() {
		...
		if ((moment() > this.midnight) || (!this.loaded)) {
			...
			if (this.config.displaySun == 1) {
				this.displayCalendar(0, month, year, monthName, monthLength, startingDay);
			}
			
			if (this.config.displayLunar == 1) {
				this.displayCalendar(1, month, year, monthName, monthLength, startingDay);
			}
	...
	displayCalendar: function(calendarType, month, year, monthName, monthLength, startingDay) {
		...
		if (this.config.debugging) {
			...
			if (calendarType == 1) {
				jd = jdFromDate(moment().date(), month, year);
