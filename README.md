...
This module is modified form Monthly calendar by Ashley M. Kirchner. Additional feature is Lunar calendar.

Lunar calendar calculation algorithm is modified from Hồ Ngọc Đức's article
...
<table>
	...
	<tbody>
		...
		<tr>
			<td><code>displayLunar</code></td>
			<td>Display Lunar calendar or not. "1" means display.</td>
			<td><code>5</code> seconds</td>
		</tr>
		<tr>
			<td><code>displaySun</code></td>
			<td>Display Sun calendar or not. "1" means display.</td>
			<td><code>5</code> seconds</td>
		</tr>
		<tr>
			<td><code>displayLang</code></td>
			<td>Calendar language. Vietnamese: "vn", English: "en" </td>
			<td><code>5</code> seconds</td>
		</tr>
	</tbody>
</table>
